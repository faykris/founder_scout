...
export default async function co_founders_search(p_list, geoId, count) { // filter by country: Colombia -> bingGeo:(includedValues:List((id:100876405))),
  const result = await fetch("https://www.linkedin.com/sales-api/salesApiPeopleSearch?" +
    ...
    "headers": {
      ...
      "x-li-lang": "en_US",
      "x-li-page-instance": "urn:li:page:d_sales2_search_people_saved_all;K6f0cgcRQgGndBQf71gIsA==",
      ...
      "Referer": "https://www.linkedin.com/sales/search/people?savedSearchId=50501059&searchSessionId=rOTthlpWSLWKx25ke%2F%2B8nQ%3D%3D",
